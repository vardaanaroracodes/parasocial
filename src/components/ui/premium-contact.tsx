...
export function PremiumContact() {
  ...
  return (
    <section className="relative py-32 bg-gradient-to-br from-black via-orange-950/20 to-black text-white overflow-hidden">
      {/* Enhanced Background Effects */}
      <div className="absolute inset-0">
        {/* Subtle animated gradient mesh with theme colors */}
        <motion.div 
          className="absolute inset-0 bg-gradient-to-br from-primary/[0.02] via-secondary/[0.01] to-destructive/[0.02] dark:from-primary/[0.03] dark:via-secondary/[0.02] dark:to-destructive/[0.03]"
          animate={{
        ...
        {/* Moving orbs with theme colors */}
        <motion.div
          className="absolute top-1/3 left-1/5 w-96 h-96 bg-primary/[0.03] dark:bg-primary/[0.05] rounded-full blur-3xl"
          animate={{
            x: [0, 200, 0],
            y: [0, 100, 0],
            scale: [1, 1.3, 1],
        ...
        />
        <motion.div
          className="absolute bottom-1/4 right-1/5 w-80 h-80 bg-destructive/[0.03] dark:bg-destructive/[0.05] rounded-full blur-3xl"
          animate={{
            x: [0, -150, 0],
            y: [0, -80, 0],
            scale: [1, 1.2, 1],
      ...
      >
        ...
        >
          ...
          >
            ...
            <br />
            <motion.span 
              className="bg-clip-text text-transparent bg-gradient-to-r from-primary via-secondary to-destructive"
              animate={{
        ...
        >
          {companyStats.map((stat, index) => (
            ...
            >
              <motion.div
                className="w-12 h-12 rounded-xl bg-gradient-to-br from-primary/20 to-secondary/20 border border-border flex items-center justify-center mx-auto mb-3"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              {!isSubmitted ? (
                ...
                >
                  ...
                  <motion.button
                    ...
                    className="w-full relative group overflow-hidden bg-gradient-to-r from-yellow-500 to-orange-600 hover:from-yellow-600 hover:to-orange-700 text-black font-medium py-4 px-6 rounded-xl transition-all disabled:opacity-50"
                ...
                >
                  ...
                  <motion.button
                    ...
                    className="px-6 py-3 bg-secondary border border-border rounded-xl text-secondary-foreground hover:bg-secondary/80 transition-all"
          ...
          >
            <div>
              <h3 className="text-3xl font-bold text-foreground mb-4">Other ways to reach us</h3>
              <p className="text-muted-foreground text-lg">
            ...
            <div className="space-y-6">
              {contactMethods.map((method, index) => (
                <motion.a
                  key={index}
                  href={method.link}
                  className="block p-6 bg-card backdrop-blur-xl rounded-2xl border border-border hover:bg-accent/50 transition-all group"
                  variants={fadeInUp}
            ...
            {/* Additional Info */}
            <motion.div
              className="p-6 bg-gradient-to-br from-primary/[0.08] to-secondary/[0.08] backdrop-blur-xl rounded-2xl border border-primary/30"
              variants={fadeInUp}
            >
